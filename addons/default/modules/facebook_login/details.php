...
class Module_facebook_login extends Module
{
        ...
        {
                // check if Facebook Spark is installed (should be in system/sparks/facebook-sdk/0.0.1)
                // todo not case sensitive
                if (!is_dir('system/sparks/facebook-sdk/0.0.1'))
                {
                        return FALSE;
                }

                // add settings to config for your Facebook App
                $settings = array(
                    'login_setting' => array(
                        'slug' => 'login_setting',
                    ...
                    'login_fb_display' => array(
                        ...
                        'default' => 'page', // more information available on Facebook Website : http://developers.facebook.com/docs/reference/dialogs/oauth/
                        'value' => '',
                        'type' => 'text',
                        '`options`' => '',
                        'is_required' => 1,
                ...
                // check if there is a field facebook_id in users default_profiles
