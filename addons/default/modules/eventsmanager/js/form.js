...
//  });
  ...
  {
    $('div#choosing > ul#cp-folder-content > li > input[type=radio]').click(function() { updateSelectedCoverPhoto(this); });
    $('div#choosing > ul#cp-folder-content > li > img').click(function() {
      var radio = $(this).siblings('input[type=radio]'); $(radio).attr('checked', 'checked'); updateSelectedCoverPhoto(radio);
    });
  }
  ...
  $('a#map-refresh').click(function() { refreshMap(); });
