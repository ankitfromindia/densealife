...
class Index extends Public_Controller
{
    ...
    public function thumbnail()
    {
        ...
        $album_images = array();
        $albums = $this->album_m->get_albums($user_id, $id);
        ...
        echo load_view('profile','index/partials/form_picture',array('pictures' =>$album_images, 'event' => $event)); exit; 
    }
