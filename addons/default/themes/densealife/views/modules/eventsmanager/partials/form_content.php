     ...
     <tr>
        <td>
            <div class="input">
                ...
                <input type="radio" name="comment_permission" value="FOLLOWER" <?php if(isset($event->comment_permission) && $event->comment_permission == 'FOLLOWER') : echo 'checked="checked"'; endif; ?>>Followers can comment
                <input type="radio" name="comment_permission" value="CREATER" <?php if(isset($event->comment_permission) && $event->comment_permission == 'CREATER') : echo 'checked="checked"'; endif; ?>>Only I can post
            </div>
        </td>
    </tr>
    ...
    <tr>
        <td>
            <div class="input">
                ...
                <input type="checkbox" name="comment_approval" value="YES" <?php if(isset($event->comment_approval) && $event->comment_approval == 'YES') : echo 'checked="checked"'; endif; ?>>Comments by user must be approved by me before being visible
            </div>
        </td>
    </tr>
    <tr>
