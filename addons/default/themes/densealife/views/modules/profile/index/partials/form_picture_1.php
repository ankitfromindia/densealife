        ...
        <ul id="folder-content" class="videos" style="height:293px; overflow-y: scroll;">
            ...
            if ( !empty($pictures) ) :
                foreach ( $pictures as $pic ) {
                    echo '<li>'
                    .'<a class="fancybox fl mr10" data-fancybox-group="gallery" href="'.str_replace('{{ url:site }}','',$pic->path).'">'
...
<div id="col_2">
    ...
    <div id="cropping">
        ...
        <div id="preview-wrapper">
            <div id="preview">
<?php
if ( isset($picture) ) : echo img(array( 'src' => UPLOAD_PATH . 'files/' . $picture->filename, 'id' => 'cropped-picture-preview' ));
