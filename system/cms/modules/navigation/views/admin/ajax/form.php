...
<?php endif ?>
			...
			<label class="label" for="parent_name"><?php echo lang('nav:parent_label');?></label>
					<?php echo form_dropdown('parent', array(lang('nav:link_module_select_default'))+$parent_link) ?>
            </li>
			<li class="<?php echo alternator('', 'even') ?>">
