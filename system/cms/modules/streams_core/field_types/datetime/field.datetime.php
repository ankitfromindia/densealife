...
class Field_datetime
{
    ...
    private function parse_restrict($field_data)
    {
        ...
        if ( !isset($field_data['start_date']) )
            $field_data['start_date'] = null ;
        if ( !isset($field_data['end_date']) )
            $field_data['end_date']   = null ;
    ...
    public function form_output($data, $entry_id, $field)
    {
        ...
        if ( !isset($data['custom']['start_date']) )
            $data['custom']['start_date'] = null ;
        if ( !isset($data['custom']['end_date']) )
            $data['custom']['end_date']   = null ;
