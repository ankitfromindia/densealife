    ...
    <div class="content">
        ...
        <div class="tabs">
            ...
            <ul class="tab-menu">
                ...
                <?php if ( $stream_fields ): ?><li><a href="#page-content"><span><?php if ( $page_type->content_label ): echo lang_label($page_type->content_label) ;
                else: echo lang('pages:content_label') ;
                endif ?></span></a></li><?php endif ?>
            ...
            <div class="form_inputs" id="page-details">
                ...
                <fieldset>
                    ...
                    <ul>
                        ...
                        <li>
                            <label for="title"><?php if ( $page_type->title_label ): echo lang_label($page_type->title_label) ;
            else: echo lang('global:title') ;
...
<?php if ( $stream_fields ): ?>
    <?php //echo '<pre>'; print_r($stream_fields); exit;   ?>
                <!-- Content tab -->
